 ...
 * In dev, use a relative URL so the request goes through the Vite proxy (port 5173).
 * This ensures mobile devices (USB debugging, LAN) don't need direct access to port 3000.
 */
