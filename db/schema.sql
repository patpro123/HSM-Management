...
-- notifications.user_id: the specific recipient. NULL is reserved for true
-- system-wide broadcasts (rare) — role/event-scoped notifications (prospects,
-- homework) are fanned out as one row per recipient, not left NULL.
